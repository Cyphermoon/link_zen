...
const AddProfileLink = () => {
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>, formik: FormikProps<AddProfileLinkFormFields>) => {
        e.preventDefault();
        e.stopPropagation();
    ...
    const handleDrop = (e: React.DragEvent<HTMLDivElement>, formik: FormikProps<AddProfileLinkFormFields>) => {
        e.preventDefault();
        e.stopPropagation();
        formik.setFieldTouched("linkImage", true)
        setDragActive(false);
                                ...
                                <FormControl label='Upload Image' labelId='linkImage'>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {fileName ?
                                                <span className='mb-2 animate-in fade-in-0 duration-300'>{fileName}</span> // Display the file name
                                                :
                                                <span>
