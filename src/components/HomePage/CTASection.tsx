...
import { urbanist, raleway } from 'font'
    ...
    return (
        <section className='bg-accent text-white pt-5 lg:pt-10  pb-10 lg:pb-10'>
            <Container className='flex flex-col lg:flex-row justify-between items-center text-center lg:text-left space-y-5 lg:space-y-0' >
                <h2 className={`${raleway.className} normal-case font-semibold lg:font-bold text-4xl lg:text-5xl lg:leading-tight w-full lg:w-6/12`}>
                    Get your content out there today!
                </h2>
